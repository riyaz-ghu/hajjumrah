...
interface WhatsAppButtonProps {
  ...
  message?: string;
  type?: string; // Prop to force WhatsApp button for support
}

export default function WhatsAppButton({
  className = "",
  children,
  message = "Hi, I'm interested in Hajj & Umrah packages",
  type = ""
}: WhatsAppButtonProps) {
  ...
  // If LOGGED OUT (default), show WhatsApp button
  return (
    <Button
      onClick={handleWhatsAppClick}
      className={`bg-green-600 hover:bg-green-700 flex items-center gap-2 ${className}`}
